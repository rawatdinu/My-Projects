<%@ Page Language="C#" MasterPageFile="~/NewMasterPage.Master" AutoEventWireup="true" CodeBehind="EditJobPost.aspx.cs" Inherits="DemoProject.EditJobPost" Title="Edit Job" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="DropDownExpMin" runat="server" Width="70px" 
                                        AutoPostBack="True" onselectedindexchanged="DropDownExpMin_SelectedIndexChanged" 
                                      >
                                    </asp:DropDownList>
                                    &nbsp;(Min)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnPostJob" runat="server" Font-Size="9pt" 
                                        Text="Update Job" Width="110px" onclick="btnPostJob_Click"  />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                            </tr>
                            <tr>
