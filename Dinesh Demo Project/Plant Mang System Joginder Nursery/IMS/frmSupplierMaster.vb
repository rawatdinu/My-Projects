...
Public Class frmSupplierMaster
    ...
    Private Sub frmSupplierMaster_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        SupplierMaster = Nothing
    End Sub
    Private Sub EnableControl(ByVal status As Boolean)
        ...
        txtSupplierName.ReadOnly = status
        txtAddress.ReadOnly = status
        txtAccHolderName.ReadOnly = status
        txtAccNo.ReadOnly = status
        txtBranch.ReadOnly = status
        txtCBSCode.ReadOnly = status
    ...
    Private Sub frmSupplierMaster_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        TrapKeyDown(e.KeyCode)
    End Sub

    Private Sub frmSupplierMaster_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        EnableControl(True)
        Display()
    End Sub
    ...
    Private Sub cmdAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        ...
        EnableControl(False)
        ClearControl()
        txtSupplierCode.Text = showCode("Supplier")
    ...
    Private Sub Save()
        ...
        Try
            ...
            f_SupplierCode = txtSupplierCode.Text
            ...
            Else
                If bln_AddOn = True Then
                    If MsgQuestion("SAVE") = 6 Then
                        ...
                        StrQuery = "insert into SupplierMaster1 (SupplierCode,SupplierName,Address,LocalityCode,Phone,Fax,EmailId,Website,TINNo,PANNo,AccNo,AccHolderName,BankName,Branch,CBSCode,OpeningBalance,Balance)values('" & txtSupplierCode.Text & "','" & txtSupplierName.Text & "','" & txtAddress.Text & "','" & localitycode & "','" & txtPhone.Text & "','" & txtFax.Text & "','" & txtEmail.Text & "','" & txtwebsite.Text & "','" & txtTinNo.Text & "','" & txtPANNo.Text & "','" & txtAccNo.Text & "','" & txtAccHolderName.Text & "','" & txtBankName.Text & "','" & txtBranch.Text & "','" & txtCBSCode.Text & "'," & Val(txtOpeningBalance.Text) & "," & Val(txtOpeningBalance.Text) & ")"
                        ...
                        StrQuery = "insert into  LedgerMaster  (LedgerCode,OpeningBalance)values('" & txtSupplierCode.Text & "'," & Val(txtOpeningBalance.Text) & ")"
                        ...
                        StrQuery = "Update  sequencemaster set lastvalue=lastvalue+1 where head='Supplier'"
                        ComSave = New SqlClient.SqlCommand(StrQuery, gl_Con)
                        ComSave.CommandType = CommandType.Text
                        ComSave.Transaction = trn
                        ComSave.ExecuteNonQuery()
                ...
                ElseIf bln_EditOn = True Then
                    ...
                    If MsgQuestion("UPDATE") = 6 Then
                        ...
                        StrQuery = "Update SupplierMaster1 Set SupplierName='" & txtSupplierName.Text & "',Address='" & txtAddress.Text & "', LocalityCode='" & localitycode & "',Phone='" & txtPhone.Text & "',Fax='" & txtFax.Text & "',EmailId='" & txtEmail.Text & "',Website='" & txtwebsite.Text & "',PANNo='" & txtPANNo.Text & "',TINNo='" & txtTinNo.Text & "',AccNo='" & txtAccNo.Text & "',AccHolderName='" & txtAccHolderName.Text & "',BankName='" & txtBankName.Text & "',Branch='" & txtBranch.Text & "',CBSCode='" & txtCBSCode.Text & "',OpeningBalance=" & Val(txtOpeningBalance.Text) & " where SupplierCode='" & txtSupplierCode.Text & "'"
                        ...
                        StrQuery = "delete from  LedgerMaster  where LedgerCode='" & txtSupplierCode.Text & "'"
            ...
            Call Display(txtSupplierCode.Text)
    ...
    Private Sub Display(Optional ByVal f_display As String = "-1")
        ...
        Try
            If f_display = "-1" Then
                Strquery = "SELECT  SupplierMaster1.AccNo,SupplierMaster1.AccHolderName,SupplierMaster1.BankName,SupplierMaster1.Branch,SupplierMaster1.CBSCode,SupplierMaster1.OpeningBalance,SupplierMaster1.SupplierId, SupplierMaster1.SupplierCode, SupplierMaster1.SupplierName, SupplierMaster1.Address, SupplierMaster1.LocalityCode, LocalityMaster.LocalityName, CityMaster.CityName, StateMaster.StateName, LocalityMaster.PinCode, SupplierMaster1.Phone, SupplierMaster1.Fax, SupplierMaster1.EmailId, SupplierMaster1.Website, SupplierMaster1.TINNo, SupplierMaster1.PAnNo, SupplierMaster1.Balance FROM ((SupplierMaster1 INNER JOIN LocalityMaster ON SupplierMaster1.LocalityCode = LocalityMaster.LocalityCode) INNER JOIN CityMaster ON LocalityMaster.CityCode = CityMaster.CityCode) INNER JOIN StateMaster ON CityMaster.StateCode = StateMaster.StateCode WHERE  SupplierId =(SELECT  MAX(SupplierId) FROM SupplierMaster1)"
            Else
                Strquery = "SELECT  SupplierMaster1.AccNo,SupplierMaster1.AccHolderName,SupplierMaster1.BankName,SupplierMaster1.Branch,SupplierMaster1.CBSCode,SupplierMaster1.OpeningBalance,SupplierMaster1.SupplierId, SupplierMaster1.SupplierCode, SupplierMaster1.SupplierName, SupplierMaster1.Address, SupplierMaster1.LocalityCode, LocalityMaster.LocalityName, CityMaster.CityName, StateMaster.StateName, LocalityMaster.PinCode, SupplierMaster1.Phone, SupplierMaster1.Fax, SupplierMaster1.EmailId, SupplierMaster1.Website, SupplierMaster1.TINNo, SupplierMaster1.PAnNo, SupplierMaster1.Balance FROM ((SupplierMaster1 INNER JOIN LocalityMaster ON SupplierMaster1.LocalityCode = LocalityMaster.LocalityCode) INNER JOIN CityMaster ON LocalityMaster.CityCode = CityMaster.CityCode) INNER JOIN StateMaster ON CityMaster.StateCode = StateMaster.StateCode  WHERE     SupplierMaster1.SupplierCode ='" & txtSupplierCode.Text & "'"
            End If

            da = New SqlClient.SqlDataAdapter(Strquery, gl_Con)
            da.Fill(ds, "SupplierMaster1")
            If ds.Tables("SupplierMaster1").Rows.Count > 0 Then
                localitycode = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("LocalityCode")), "", ds.Tables("SupplierMaster1").Rows(0).Item("LocalityCode"))
                lblPrimaryKey.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("SupplierId")), "", ds.Tables("SupplierMaster1").Rows(0).Item("SupplierId"))
                txtSupplierCode.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("SupplierCode")), "", ds.Tables("SupplierMaster1").Rows(0).Item("SupplierCode"))
                txtSupplierName.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("SupplierName")), "", ds.Tables("SupplierMaster1").Rows(0).Item("SupplierName"))
                txtAddress.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("Address")), "", ds.Tables("SupplierMaster1").Rows(0).Item("Address"))
                txtPANNo.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("PANNo")), "", ds.Tables("SupplierMaster1").Rows(0).Item("PANNo"))
                txtCity.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("CityName")), "", ds.Tables("SupplierMaster1").Rows(0).Item("CityName"))
                txtPin.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("PinCode")), "", ds.Tables("SupplierMaster1").Rows(0).Item("PinCode"))
                txtPhone.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("Phone")), "", ds.Tables("SupplierMaster1").Rows(0).Item("Phone"))
                txtFax.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("Fax")), "", ds.Tables("SupplierMaster1").Rows(0).Item("Fax"))
                txtTinNo.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("TINNo")), "", ds.Tables("SupplierMaster1").Rows(0).Item("TINNo"))
                txtState.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("StateName")), "", ds.Tables("SupplierMaster1").Rows(0).Item("StateName"))
                txtLocality.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("LocalityName")), "", ds.Tables("SupplierMaster1").Rows(0).Item("LocalityName"))
                txtEmail.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("EmailId")), "", ds.Tables("SupplierMaster1").Rows(0).Item("EmailId"))
                txtwebsite.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("Website")), "", ds.Tables("SupplierMaster1").Rows(0).Item("Website"))
                txtOpeningBalance.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("OpeningBalance")), 0, ds.Tables("SupplierMaster1").Rows(0).Item("OpeningBalance"))

                txtAccNo.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("AccNo")), "", ds.Tables("SupplierMaster1").Rows(0).Item("AccNo"))
                txtAccHolderName.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("AccHolderName")), "", ds.Tables("SupplierMaster1").Rows(0).Item("AccHolderName"))
                txtBankName.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("BankName")), "", ds.Tables("SupplierMaster1").Rows(0).Item("BankName"))
                txtBranch.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("Branch")), "", ds.Tables("SupplierMaster1").Rows(0).Item("Branch"))
                txtCBSCode.Text = IIf(IsDBNull(ds.Tables("SupplierMaster1").Rows(0).Item("CBSCode")), "", ds.Tables("SupplierMaster1").Rows(0).Item("CBSCode"))
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub TrapKeyDown(ByVal key As System.Windows.Forms.Keys)
        Try
            ...
            If cmdCancel.Enabled = False Then
                ...
                strMinMaxKey = "select max(SupplierId) AS MaxId,MIN(SupplierId) As MinId from SupplierMaster1"
                ...
                Select Case key
                    ...
                    Case Keys.F3 'First Record
                        ...
                        strNextRecord = "select SupplierCode  from SupplierMaster1 where SupplierId=" & nextKey & ""
                        daMinMaxKey = New SqlClient.SqlDataAdapter(strNextRecord, gl_Con)
                        daMinMaxKey.Fill(dsMinMaxKey, "PurchaseNavigation")

                        txtSupplierCode.Text = dsMinMaxKey.Tables("PurchaseNavigation").Rows(0).Item("SupplierCode")
                        Call Display(txtSupplierCode.Text)
                        dsMinMaxKey.Clear()
    ...
    Private Sub Designgrid()
        ...
        'Strquery = "Select SupplierCode,Suppliername,Address from SupplierMaster1 order by Suppliername"
        'da = New SqlClient.SqlDataAdapter(Strquery, gl_Con)
        'da.Fill(ds, "FillGrid")
    ...
    '    '        txtSupplierCode.Text = fgSearch.get_TextMatrix(fgSearch.RowSel, 1)
    '    '        Display("txtSupplierCode.Text")
    '    '        gbSearch.SendToBack()
    '    '        Panel1.Enabled = True
    '    '    End If
            ...
            If ds.Tables("FillGrid").Rows.Count > 0 Then
                With dgSearch
                    For i = 0 To ds.Tables("FillGrid").Rows.Count - 1
                        ...
                        .Rows(i).Cells(1).Value = IIf(IsDBNull(ds.Tables("FillGrid").Rows(i).Item("SupplierCode")), "", ds.Tables("FillGrid").Rows(i).Item("SupplierCode"))
                        .Rows(i).Cells(2).Value = IIf(IsDBNull(ds.Tables("FillGrid").Rows(i).Item("Suppliername")), "", ds.Tables("FillGrid").Rows(i).Item("Suppliername"))

                        .Rows(i).Cells(3).Value = IIf(IsDBNull(ds.Tables("FillGrid").Rows(i).Item("Address")), "", ds.Tables("FillGrid").Rows(i).Item("Address"))
    ...
    Private Sub cmdsearchCity_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdsearchCity.Click
        Dim StrQuery As String
        Dim i As Integer
        Designgrid2()
        da1.Dispose()
            ...
            If search = 0 Then
                ...
                Else
                    If .RowCount > 1 And intDGSearchKeayPress = 1 Then
                        txtSupplierCode.Text = dgSearch(1, Convert.ToInt32(.CurrentRow.Index - 1)).Value.ToString
                    Else
                        txtSupplierCode.Text = dgSearch(1, Convert.ToInt32(.CurrentRow.Index)).Value.ToString
                    End If
    ...
    Private Sub txtSearch_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtSearch.TextChanged
        ...
        Try
            If search = 0 Then
                dv = New DataView(ds.Tables(0), "Suppliername Like '" & Trim(txtSearch.Text) & "*" & "'", "SupplierCode", DataViewRowState.CurrentRows)
                dTable = dv.ToTable
                dgSearch.RowCount = 1
