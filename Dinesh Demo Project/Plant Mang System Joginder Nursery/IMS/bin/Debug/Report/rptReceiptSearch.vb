...
Public Class rptReceiptSearch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IMS.rptReceiptSearch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceiptSearch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceiptSearch = New rptReceiptSearch()
        rpt.Site = Me.Site
        Return rpt
    End Function
