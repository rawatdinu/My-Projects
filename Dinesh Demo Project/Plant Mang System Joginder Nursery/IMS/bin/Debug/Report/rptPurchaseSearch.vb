...
Public Class rptPurchaseSearch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IMS.rptPurchaseSearch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchaseSearch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchaseSearch = New rptPurchaseSearch()
        rpt.Site = Me.Site
        Return rpt
    End Function
