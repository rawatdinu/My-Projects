...
Public Class rptCompanyMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IMS.rptCompanyMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCompanyMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCompanyMaster = New rptCompanyMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
