...
Public Class rptTaxInvoice_Manually
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTaxInvoice_Manually.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IMS.rptTaxInvoice_Manually.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SINO() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rptTaxMasterrpt_SINO1() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptTaxInvoice_Manually
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTaxInvoice_Manually = New rptTaxInvoice_Manually()
        rpt.Site = Me.Site
        Return rpt
    End Function
