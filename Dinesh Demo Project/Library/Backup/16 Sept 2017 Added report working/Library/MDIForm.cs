...
namespace Library
{
    public partial class MDIForm : Form
    {
        ...
        public frmReportViewer frmReportViewer;
            ...
            try
            {
                switch (formName)
                {
                    ...
                    case "frmReportViewer":
                        if (frmReportViewer == null)
                        {
                            frmReportViewer = new frmReportViewer();
                            frmReportViewer.MdiParent = this;
                            frmReportViewer.Show();
                            frmReportViewer.BringToFront();
                        }
                        else if (frmReportViewer.IsDisposed == true)
                        {
                            frmReportViewer = new frmReportViewer();
                            frmReportViewer.MdiParent = this;
                            frmReportViewer.Show();
